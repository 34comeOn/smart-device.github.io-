...
var popupNameInputElement = document.querySelector('.name-input');
var popupOpenButtonElement = document.querySelector('.header__button-link');
var popupCloseButtonElement = popupElement.querySelector('.popup__close-button');
var footerContainerElement = document.querySelector('.footer__container');
var feedbackFormElement = document.querySelector('.feedback__form');
var aboutWrapperElement = document.querySelector('.about__info-wrapper');
var aboutButtonElement = document.querySelector('.about__button');
var navigationToggleElement = document.querySelector('.footer__toggle-nav');
var contactsToggleElement = document.querySelector('.footer__toggle-contacts');
...
var onPopupEscKeydown = function onPopupEscKeydown(evtClose) {
...
var removeEscListener = function removeEscListener() {
  document.removeEventListener('keydown', onPopupEscKeydown);
};

var setEditClickHandler = function setEditClickHandler(element) {
...
var validateForm = function validateForm(form) {
  var nameInputElement = form.querySelector('input[name="name"]');
  var phoneInputElement = form.querySelector('input[name="phone"]');
  var labelFormElement = form.querySelector('.checkbox-label');
  var buttonFormElement = form.querySelector('.form__button');
  var formCheckboxElement = form.querySelector('.form__checkbox');

  var onLabelClick = function onLabelClick(label, submitButton) {
  ...
  var onLabelEnterPush = function onLabelEnterPush(label, submitButton) {
    if (!label.classList.contains('checkbox-label--checked')) {
      label.classList.add('checkbox-label--checked');
      submitButton.removeAttribute('disabled');
  ...
  var interactLabel = function interactLabel(someLabel, buttonToDisable) {
    onLabelEnterPush(someLabel, buttonToDisable);
  };

  var onLabelEnterKeydown = function onLabelEnterKeydown(evtEnterKeydown) {
...
validateForm(feedbackFormElement); // function modalShow() {
...
var modalFocusTrap = focus_trap__WEBPACK_IMPORTED_MODULE_1__["createFocusTrap"]('#popup', {
  onActivate: function onActivate() {
    return popupNameInputElement.focus();
  }
});
...
var toggleTabs = function toggleTabs(footerContainer, hiddingElement, togglingElement) {
  if (footerContainer.classList.contains("".concat(hiddingElement, "-opened"))) {
    footerContainer.classList.remove("".concat(hiddingElement, "-opened"));
  }

  footerContainer.classList.toggle("".concat(togglingElement, "-opened"));
};
