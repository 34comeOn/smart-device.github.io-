...
var popupOpenElement = document.querySelector('.header__button-link');
var popupCloseButtonElement = popupElement.querySelector('.popup__close-button');
var footerElement = document.querySelector('.footer__container');
var popupSubmitElement = popupElement.querySelector('.popup__button');
var collectionOfNameInputElements = document.querySelectorAll('input[name="name"]');
var collectionOfPhoneInputElements = document.querySelectorAll('input[name="phone"]');
var collectionOfCheckboxElements = document.querySelectorAll('input[type="checkbox"]');
var collectionOfLabelElements = document.querySelectorAll('label');
...
var _iterator = _createForOfIteratorHelper(collectionOfPhoneInputElements),
    _step;
...
var validateForms = function validateForms() {}; // const validateInput = (element, re, text) => {
