...
var footerContainerElement = document.querySelector('.footer__container'); // const popupSubmitElement = popupElement.querySelector('.popup__button');
...
var validateForm = function validateForm(form) {
  ...
  var pushLabel = function pushLabel(someLabel, buttonToDisable) {
...
popupOpenButtonElement.addEventListener('click', function () {
  var popupNameInputElement = popupElement.querySelector('#popup__close');
